...
set :deploy_to, '/web/ronglian_im'
set :current_path, 'current'
set :repository, 'https://github.com/blackdust/ronglian.git'
set :branch, 'master'
set :user, 'root'
set :term_mode, nil
...
task :setup => :environment do
  ...
  order = MinaUtil::Builder.ask_mongoid('ronglian_im')
  ...
  nginx = MinaUtil::Builder.ask_nginx('ronglian_im', '/web/ronglian_im')
  queue! %[echo '#{nginx}' > "/etc/nginx/conf.d/ronglian_im.conf"]
  #test
  #queue! %[echo '#{nginx}' > "/home/dd/ronglian_im.conf"]
